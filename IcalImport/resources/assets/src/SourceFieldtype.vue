    ...
    computed: {
        ...
        suggestConfig() {
            return {
                ...
                max_items: 1,
                create: true,
                placeholder: translate('addons.IcalImport::messages.source_suggest_placeholder')
            }
        },

        suggestSuggestions() {
            return IcalImport.fieldSuggestions.filter(item => this.allowedFieldtypes.includes(item.type));
        },
