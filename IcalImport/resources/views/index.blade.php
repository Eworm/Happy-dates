...
@section('content')
    ...
    <icalimport-feed-list inline-template>
        ...
        <div class="flex items-center mb-3">
            ...
            <div class="controls flex flex-wrap justify-center md:block items-center w-full md:w-auto">
                ...
                <a href="{{ route('addons.icalimport.create') }}" class="btn btn-primary ml-1 mt-1 md:mt-0">Add a feed</a>
            </div>
        </div>
                        ...
                        @foreach ($icals as $ical)
                            ...
                            <tr>
                                ...
                                <td class="cell-title first-cell">
                                    <a href="{{ route('addons.icalimport.edit', $ical->name) }}">
                                        {{ $ical->title }}
                                    </a>
                                </td>
