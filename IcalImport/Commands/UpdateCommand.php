...
namespace Statamic\Addons\IcalImport\Commands;
...
class UpdateCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'icalimport:refresh';
    ...
    public function handle()
    {
        ...
        foreach ($events_storage as $event) {
            $st_event = str_replace('site/storage/addons/IcalImport/', '', $event);
    ...
    /**
     * Run the `IcalImport:beforecreate` event.
     *
